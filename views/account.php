							...
							echo'<div class="col-xs-12">';
								...
								echo '<div class="panel panel-default">';
									...
									echo '<div class="panel-body">';								
										...
										echo '<iframe src="' . $this->parent->server->url . '/agreement/?overview=' . $this->parent->ltple_encrypt_uri($this->parent->user->user_email) . '&du=' . $this->parent->urls->primary . '&_='.time().'" style="margin-top: -65px;position:relative;top:0;bottom:0;width:100%;height:500px;overflow:hidden;border:0;"></iframe>';
