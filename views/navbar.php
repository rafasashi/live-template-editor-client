<?php 
	...
	if( !$ltple->layer->in_editor('gutenberg') && (empty($ltple->profile->id) || $ltple->user->loggedin) ){
		...
		if( !$ltple->inWidget ){
			...
			echo'<div id="navbar_2" class="row" style="box-shadow:inset 0 -1px 10px -6px rgba(0,0,0,0.75);background: rgb(236, 236, 236);padding: 8px 0;margin: 0;border-bottom: 1px solid #ddd;position: relative;line-height:26px;">';
