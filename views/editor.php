...
<iframe id="editorIframe" src="<?php echo $this->urls->editor . '?uri=' . $this->layer->id . '&lk=' . md5( 'layer' . $this->layer->id . $this->_time ) . '&_=' . $this->_time; ?>" style="margin-top: -65px;position: relative;width: 100%;top: 0;bottom: 0;border:0;height: 1200px;overflow: hidden;"></iframe>
