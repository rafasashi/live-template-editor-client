					...
					foreach($this->all->layerType as $term){
						...
						if(isset($this->layer->released[$term->slug])){
							...
							echo '<li'.$class.'>';
								...
								echo '<a href="' . $this->urls->editor . '?gallery=' . $term->slug . '">' . $term->name . '</a>';
						...
						elseif( $this->user->is_admin ){
							...
							echo '<li'.$class.'>';
								...
								echo '<a href="' . $this->urls->editor . '?gallery=' . $term->slug . '">' . $term->name . ' <span class="label label-warning pull-right"> admin </span></a>';
