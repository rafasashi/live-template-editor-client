							...
							echo'<div class="col-xs-12">';
								...
								echo '<div class="panel panel-default">';
									...
									echo '<div class="panel-body">';								
										...
										echo '<iframe src="' . $this->server->url . '/agreement/?overview=' . $this->ltple_encrypt_uri($this->user->user_email) . '" style="width:100%;height:400px;overflow:hidden;border:0;"></iframe>';
