...
class LTPLE_Client {
	...
	public function get_app_types(){
		...
		return ['networks','images','videos','blogs'];
	}
	...
	public function ltple_send_email_model( $model_id, $user){
		...
		if($can_spam !== 'false'){
			...
			if(isset($model->ID)){
				...
				$Email_title = $this->ltple_do_email_shortcodes($Email_title, $user);
	...
	public function ltple_do_email_shortcodes( $str, $user){
