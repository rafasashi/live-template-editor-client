...
class LTPLE_Client_App {
	...
	/**
	 * Main LTPLE_Client_App Instance
	 *
	 * Ensures only one instance of LTPLE_Client_App is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see LTPLE_Client_App()
	 * @return Main LTPLE_Client_App instance
	 */
