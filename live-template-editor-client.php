 ...
 */
	...
	*/
	...
	LTPLE_Client()->register_post_type( 'user-bookmark', __( 'User bookmarks', 'live-template-editor-client' ), __( 'User bookmark', 'live-template-editor-client' ), '', array(
	...
	*/
	...
	LTPLE_Client()->register_taxonomy( 'app-type', __( 'App Type', 'live-template-editor-client' ), __( 'App Type', 'live-template-editor-client' ),  array('user-image','user-bookmark','user-app'), array(
		'hierarchical' 			=> true,
		'public' 				=> false,
		'show_ui' 				=> true,
		'show_in_nav_menus' 	=> true,
