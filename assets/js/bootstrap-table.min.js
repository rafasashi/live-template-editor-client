                ...
                o(t, [
                        ...
                        value: function () {
                            if (this.options.locale) {
                                ...
                                (t[0] = t[0].toLowerCase()),
                                    ...
                                    e[this.options.locale] ? n.extend(this.options, e[this.options.locale]) : e[t.join("-")] ? n.extend(this.options, e[t.join("-")]) : e[t[0]] && n.extend(this.options, e[t[0]]);
                            }
                        },
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.$container = n(
                                ...
                                (this.$toolbar = this.options.buttonsToolbar ? n("body").find(this.options.buttonsToolbar) : this.$container.find(".fixed-table-toolbar")),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                this.$header.length ? this.options.theadClasses && this.$header.addClass(this.options.theadClasses) : (this.$header = n('<thead class="' + this.options.theadClasses + '"></thead>').appendTo(this.$el)),
                                this.$header.find("tr").each(function (e, t) {
                                    var a = [];
                                    n(t)
                                        .find("th")
                                        .each(function (e, t) {
                                            "undefined" != typeof n(t).data("field") && n(t).data("field", "" + n(t).data("field")),
                                                a.push(
                                                    n.extend(
                                                        {},
                                                        {
                        ...
                        value: function () {
                            ...
                            (this.header = { fields: [], styles: [], classes: [], formatters: [], events: [], sorters: [], sortNames: [], cellStyles: [], searchables: [] }),
                                this.options.columns.forEach(function (a, n) {
                                    o.push("<tr>"),
                                        0 === n &&
                                            ...
                                            o.push('<th class="detail" rowspan="' + t.options.columns.length + '">\n            <div class="fht-cell"></div>\n            </th>\n          '),
                                        a.forEach(function (i, a) {
                                            var s = "",
                                                ...
                                                g = i.width;
                                            if (
                                                (void 0 === i.width || t.options.cardView || "string" != typeof i.width || -1 === i.width.indexOf("%") || (h = "%"),
                                                i.width && "string" == typeof i.width && (g = i.width.replace("%", "").replace("px", "")),
                                                (l = r.sprintf("text-align: %s; ", i.halign ? i.halign : i.align)),
                                                (d = r.sprintf("text-align: %s; ", i.align)),
                                                (p = r.sprintf("vertical-align: %s; ", i.valign)),
                                                (p += r.sprintf("width: %s; ", (i.checkbox || i.radio) && !g ? (i.showSelectTitle ? void 0 : "36px") : g ? g + h : void 0)),
                                            ...
                                            o.push(
                                                ...
                                                i.checkbox || i.radio ? r.sprintf(' class="bs-checkbox %s"', i["class"] || "") : c,
                                                ...
                                                o.push(r.sprintf('<div class="th-inner %s">', t.options.sortable && i.sortable ? "sortable both" : "")),
                                                (s = t.options.escape ? r.escapeHTML(i.title) : i.title);
                                            var u = s;
                                            i.checkbox && ((s = ""), !t.options.singleSelect && t.options.checkboxHeader && (s = '<input name="btSelectAll" type="checkbox" />'), (t.header.stateField = i.field)),
                                                i.radio && ((s = ""), (t.header.stateField = i.field), (t.options.singleSelect = !0)),
                                ...
                                !this.options.showHeader || this.options.cardView
                                    ...
                                    : (this.$header.show(), this.$tableHeader.show(), this.$tableLoading.css("top", this.$header.outerHeight() + 1), this.getCaret(), n(window).on("resize.bootstrap-table", n.proxy(this.resetWidth, this))),
                        ...
                        value: function () {
                            ...
                            -1 !== i &&
                                ...
                                this.options.customSort
                                    ? r.calculateObjectValue(this.options, this.options.customSort, [this.options.sortName, this.options.sortOrder, this.data])
                                    : this.data.sort(function (s, a) {
                                          ...
                                          return void 0 === p
                                              ? ((void 0 === l || null === l) && (l = ""),
                                                (void 0 === d || null === d) && (d = ""),
                                                e.options.sortStable && l === d && ((l = s._position), (d = a._position)),
                                                n.isNumeric(l) && n.isNumeric(d))
                                                  ? ((l = parseFloat(l)), (d = parseFloat(d)), l < d ? -1 * o : l > d ? o : 0)
                                                  : l === d
                                                  ? 0
                                                  : ("string" != typeof l && (l = l.toString()), -1 === l.localeCompare(d) ? -1 * o : o)
                        ...
                        value: function (e) {
                            ...
                            return (
                                ...
                                this.options.sortName === i.data("field")
                                    ...
                                    : ((this.options.sortName = i.data("field")),
                                      (this.options.sortOrder = this.options.rememberOrder ? ("asc" === i.data("order") ? "desc" : "asc") : this.columns[this.fieldsColumnsIndex[i.data("field")]].order)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this,
                                ...
                                s = void 0,
                                d = 0;
                            this.$toolbar.find(".bs-bars").children().length && n("body").append(n(this.options.toolbar)),
                                this.$toolbar.html(""),
                                ("string" == typeof this.options.toolbar || "object" === a(this.options.toolbar)) &&
                                    n(r.sprintf('<div class="bs-bars %s-%s"></div>', l.classes.pull, this.options.toolbarAlign)).appendTo(this.$toolbar).append(n(this.options.toolbar)),
                                (t = [r.sprintf('<div class="columns columns-%s btn-group %s-%s">', this.options.buttonsAlign, l.classes.pull, this.options.buttonsAlign)]),
                                "string" == typeof this.options.icons && (this.options.icons = r.calculateObjectValue(null, this.options.icons)),
                                this.options.showPaginationSwitch &&
                                    t.push(
                                        ...
                                        r.sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.paginationSwitchDown),
                                        "</button>"
                                    ),
                                this.options.showRefresh &&
                                    t.push(
                                        r.sprintf(
                                            '<button class="btn' + r.sprintf(" btn-%s", this.options.buttonsClass) + r.sprintf(" btn-%s", this.options.iconSize) + '" type="button" name="refresh" aria-label="refresh" title="%s">',
                                            this.options.formatRefresh()
                                        ),
                                        r.sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.refresh),
                                        "</button>"
                                    ),
                                this.options.showToggle &&
                                    t.push(
                                        r.sprintf(
                                            '<button class="btn' + r.sprintf(" btn-%s", this.options.buttonsClass) + r.sprintf(" btn-%s", this.options.iconSize) + '" type="button" name="toggle" aria-label="toggle" title="%s">',
                                            this.options.formatToggle()
                                        ),
                                        r.sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.toggleOff),
                                        "</button>"
                                    ),
                                this.options.showFullscreen &&
                                    t.push(
                                        r.sprintf(
                                            '<button class="btn' + r.sprintf(" btn-%s", this.options.buttonsClass) + r.sprintf(" btn-%s", this.options.iconSize) + '" type="button" name="fullscreen" aria-label="fullscreen" title="%s">',
                                            this.options.formatFullscreen()
                                        ),
                                        r.sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.fullscreen),
                                        "</button>"
                                    ),
                                this.options.showColumns &&
                                    (t.push(
                                        r.sprintf('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()),
                                        '<button type="button" aria-label="columns" class="btn' + r.sprintf(" btn-%s", this.options.buttonsClass) + r.sprintf(" btn-%s", this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
                                        r.sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.columns),
                                ...
                                this.options.showPaginationSwitch && this.$toolbar.find('button[name="paginationSwitch"]').off("click").on("click", n.proxy(this.togglePagination, this)),
                                this.options.showFullscreen && this.$toolbar.find('button[name="fullscreen"]').off("click").on("click", n.proxy(this.toggleFullscreen, this)),
                                this.options.showRefresh && this.$toolbar.find('button[name="refresh"]').off("click").on("click", n.proxy(this.refresh, this)),
                                this.options.showToggle &&
                                    this.$toolbar
                                ...
                                this.options.search &&
                                    ((t = []),
                                    t.push(
                                        r.sprintf('<div class="%s-%s search">', l.classes.pull, this.options.searchAlign),
                                        r.sprintf('<input class="form-control' + r.sprintf(" input-%s", this.options.iconSize) + '" type="text" placeholder="%s">', this.options.formatSearch()),
                                        "</div>"
                                    ),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                (0 < this.totalPages && this.options.pageNumber > this.totalPages && (this.options.pageNumber = this.totalPages),
                                (this.pageFrom = (this.options.pageNumber - 1) * this.options.pageSize + 1),
                                (this.pageTo = this.options.pageNumber * this.options.pageSize),
                                this.pageTo > this.options.totalRows && (this.pageTo = this.options.totalRows),
                                o.push(
                                    r.sprintf('<div class="%s-%s pagination-detail">', l.classes.pull, this.options.paginationDetailHAlign),
                                ...
                                var $ = [
                                    r.sprintf('<span class="btn-group %s">', "top" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? "dropdown" : "dropup"),
                                    '<button type="button" class="btn' + r.sprintf(" btn-%s", this.options.buttonsClass) + r.sprintf(" btn-%s", this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
                                ...
                                f.forEach(function (e, o) {
                                    ...
                                    o.push(
                                        "</div>",
                                        r.sprintf('<div class="%s-%s pagination">', l.classes.pull, this.options.paginationHAlign),
                                        '<ul class="pagination' + r.sprintf(" pagination-%s", this.options.iconSize) + '">',
                                        r.sprintf('<li class="page-item page-pre"><a class="page-link" href="#">%s</a></li>', this.options.paginationPreText)
                                    ),
                                    this.totalPages < this.options.paginationSuccessivelySize
                                        ? ((i = 1), (d = this.totalPages))
                                        : ((i = this.options.pageNumber - this.options.paginationPagesBySide), (d = i + 2 * this.options.paginationPagesBySide)),
                                    this.options.pageNumber < this.options.paginationSuccessivelySize - 1 && (d = this.options.paginationSuccessivelySize),
                                    d > this.totalPages && (d = this.totalPages),
                                    this.options.paginationSuccessivelySize > this.totalPages - i && (i = i - (this.options.paginationSuccessivelySize - (this.totalPages - i)) + 1),
                                    1 > i && (i = 1),
                                    d > this.totalPages && (d = this.totalPages);
                                ...
                                if (1 < i) {
                                    ...
                                    i - 1 === C + 1
                                        ? ((s = i - 1), o.push(x(s)))
                                        : i - 1 > C &&
                                          (i - 2 * this.options.paginationPagesBySide > this.options.paginationPagesBySide && this.options.paginationUseIntermediate
                                    ...
                                    for (
                                        d >= T && (T = d + 1),
                                            d + 1 === T - 1
                                                ? ((s = d + 1), o.push(x(s)))
                                                : T > d + 1 &&
                                                  (this.totalPages - d > 2 * this.options.paginationPagesBySide && this.options.paginationUseIntermediate
                                                      ? ((s = e((this.totalPages - v - d) / 2 + d)), o.push(x(s, " page-intermediate")))
                            ...
                            this.$pagination.html(o.join("")),
                                this.options.onlyInfoPagination ||
                                    ...
                                    this.options.smartDisplay &&
                                        ...
                                        (2 > f.length || this.options.totalRows <= f[0]) && this.$pagination.find("span.page-list").hide(),
                                        this.$pagination[this.getData().length ? "show" : "hide"]()),
                                    !this.options.paginationLoop && (1 === this.options.pageNumber && c.addClass("disabled"), this.options.pageNumber === this.totalPages && h.addClass("disabled")),
                        ...
                        value: function (e, t) {
                            ...
                            if (!(-1 < r.findIndex(this.hiddenRows, e))) {
                                ...
                                return (
                                    ...
                                    this.options.cardView && a.push('<td colspan="' + this.header.fields.length + '"><div class="card-views">'),
                                    ...
                                    this.header.fields.forEach(function (d, p) {
                                        ...
                                        if ((!o.fromHtml || "undefined" != typeof g || $.checkbox || $.radio) && $.visible && (!o.options.cardView || $.cardVisible)) {
                                            if (
                                                ...
                                                l.concat([o.header.styles[p]]).length && (w = ' style="' + l.concat([o.header.styles[p]]).join("; ") + '"'),
                                                e["_" + d + "_id"] && (m = r.sprintf(' id="%s"', e["_" + d + "_id"])),
                                                e["_" + d + "_class"] && (y = r.sprintf(' class="%s"', e["_" + d + "_class"])),
                                                e["_" + d + "_rowspan"] && (v = r.sprintf(' rowspan="%s"', e["_" + d + "_rowspan"])),
                                                e["_" + d + "_colspan"] && (x = r.sprintf(' colspan="%s"', e["_" + d + "_colspan"])),
                                                e["_" + d + "_title"] && (S = r.sprintf(' title="%s"', e["_" + d + "_title"])),
                                                (b = r.calculateObjectValue(o.header, o.header.cellStyles[p], [g, e, t, d], b)),
                                            ...
                                            if (((u = r.calculateObjectValue($, o.header.formatters[p], [g, e, t, d], g)), e["_" + d + "_data"] && !n.isEmptyObject(e["_" + d + "_data"])))
                                                for (
                                                    var F = (function (e) {
                                                            return Object.keys(e).map(function (t) {
                                                                return [t, e[t]];
                                            ...
                                            if ($.checkbox || $.radio) {
                                                ...
                                                (h = [
                                                    o.options.cardView ? '<div class="card-view ' + z + '">' : '<td class="bs-checkbox ' + z + '">',
                                                    '<input\n              data-index="' +
                                                        t +
                                                        '"\n              name="' +
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            s ? this.$body.html(a) : this.$body.html('<tr class="no-records-found">' + r.sprintf('<td colspan="%s">%s</td>', this.$header.find("th").length, this.options.formatNoMatches()) + "</tr>"),
                                e || this.scrollTo(0),
                                this.$body
                                    ...
                                    .on("click dblclick", function (e) {
                                        ...
                                        if (
                                            ...
                                            "click" === i && t.options.clickToSelect && g.clickToSelect && !t.options.ignoreClickToSelectOn(a))
                                        ) {
                                            ...
                                            for (
                                                var d = function () {
                                                        ...
                                                        t.$body.find(">tr:not(.no-records-found)").each(function (e, o) {
                                                            var i = n(o),
                                                                d = i.find(t.options.cardView ? ".card-view" : "td").eq(l),
                                                                p = a.indexOf(" "),
                                                                c = a.substring(0, p),
                                                                h = a.substring(p + 1);
                                                            d.find(h)
                        ...
                        value: function (e, t, o) {
                            ...
                            if (
                                ...
                                this.options.pagination &&
                                    ...
                                    ((l.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize), (l.pageNumber = this.options.pageNumber)),
                                ...
                                ("limit" === this.options.queryParamsType &&
                                    ...
                                    this.options.pagination &&
                                        "server" === this.options.sidePagination &&
                                        ((l.offset = this.options.pageSize === this.options.formatAllRows() ? 0 : this.options.pageSize * (this.options.pageNumber - 1)),
                                ...
                                n.isEmptyObject(this.filterColumnsPartial) || (l.filter = JSON.stringify(this.filterColumnsPartial, null)),
                                ...
                                for (var o = this.columns, a = Array.isArray(o), n = 0, _iterator17 = a ? o : o[Symbol.iterator](); ; ) {
                                    ...
                                    if (l.visible) {
                                        ...
                                        h && h.classes && (g = r.sprintf(' class="%s"', l["class"] ? [l["class"], h.classes].join(" ") : h.classes)),
                                            t.push("<th", g, r.sprintf(' style="%s"', d + p + c.concat().join("; ")), ">"),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (
                                ...
                                return this.$el.css("margin-top", "0"), this.$tableContainer.css("padding-bottom", "0"), void this.$tableFooter.hide();
                            if (
                                (this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), (t += this.$header.outerHeight())) : (this.$tableHeader.hide(), this.trigger("post-header")),
                                this.options.showFooter && (this.resetFooter(), this.options.height && (t += this.$tableFooter.outerHeight())),
                                this.options.height)
                            ) {
                            ...
                            if (e.hasOwnProperty("field") && e.hasOwnProperty("values")) {
                                for (o = t - 1; 0 <= o; o--)
                                    ((i = this.options.data[o]), !!i.hasOwnProperty(e.field)) &&
                                        ...
                                        (this.options.data.splice(o, 1), "server" === this.options.sidePagination && (this.options.totalRows -= 1));
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            if (
                                ...
                                ((this.columns[this.fieldsColumnsIndex[e.field]].title = this.options.escape ? r.escapeHTML(e.title) : e.title), this.columns[this.fieldsColumnsIndex[e.field]].visible)
                            ) {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.options.pagination ? e.attr("class", this.options.iconsPrefix + " " + this.options.icons.paginationSwitchDown) : e.attr("class", this.options.iconsPrefix + " " + this.options.icons.paginationSwitchUp),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.options.cardView ? (e.removeClass(this.options.icons.toggleOff), e.addClass(this.options.icons.toggleOn)) : (e.removeClass(this.options.icons.toggleOn), e.addClass(this.options.icons.toggleOff)),
                                this.initBody(),
                        ...
                        value: function (e) {
                            ...
                            if (e) {
                                var o = this.$body.find(r.sprintf('> tr[data-index="%s"]', 0)),
                                    ...
                                    s = !1,
                                    l = -1;
                                if ((o.next().is("tr.detail-view") ? !o.next().next().is("tr.detail-view") && (o.next().find(".detail-icon").click(), (s = !0)) : (o.find("> td > .detail-icon").click(), (s = !0)), s))
                                    try {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            else for (var t = this.$body.children(), o = 0; o < t.length; o++) this.expandRow_(!1, n(t[o]).data("index"));
                        },
                    },
                    {
